...
export default function ContactPage() {
  ...
  return (
    <>
      {/* ── Hero — iridescent banner, same pattern as Resume page ── */}
      <section className="relative bg-bg pt-20 pb-8 md:pt-28 md:pb-10 overflow-hidden flex flex-col justify-center items-center">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 md:px-8 lg:px-12 w-full text-center">
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <a
                  ...
                  className="flex items-center gap-3 rounded-xl border border-stroke bg-surface p-4 transition hover:border-[#2563EB]/40 hover:shadow-sm"
                >
                  <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-bg text-[#2563EB]">
                ...
                <div className="flex items-center gap-3 rounded-xl border border-stroke bg-surface p-4">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-[11px] text-muted">+91 70894 59947</p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-[11px] text-muted">@akshatsoni27</p>
                  </div>
                </a>

                {/* Location — centred, spans both columns */}
                <div className="col-span-2 flex justify-center">
                  <div className="flex w-1/2 items-center gap-3 rounded-xl border border-stroke bg-surface p-4">
                    <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-bg text-[#2563EB]">
                      <svg viewBox="0 0 24 24" width="18" height="18" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  <a href="mailto:akshatsoni0427@gmail.com" aria-label="Email"
                    className="flex h-10 w-10 items-center justify-center rounded-lg border border-stroke bg-surface text-red-500 transition hover:border-[#2563EB]/40 hover:shadow-sm">
                  ...
                  <a href="tel:+917089459947" aria-label="Phone"
                    className="flex h-10 w-10 items-center justify-center rounded-lg border border-stroke bg-surface text-green-600 transition hover:border-[#2563EB]/40 hover:shadow-sm">
                    <svg viewBox="0 0 24 24" width="17" height="17" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round">
                      <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.72 12 19.79 19.79 0 0 1 1.65 3.1 2 2 0 0 1 3.62 1h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.6a16 16 0 0 0 6.29 6.29l.96-.86a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z" />
                    </svg>
                  </a>
                  <a href="https://www.linkedin.com/in/akshat-soni-/" target="_blank" rel="noreferrer" aria-label="LinkedIn"
                    className="flex h-10 w-10 items-center justify-center rounded-lg border border-stroke bg-surface text-[#2563EB] transition hover:border-[#2563EB]/40 hover:shadow-sm">
                    <svg viewBox="0 0 24 24" width="17" height="17" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round">
                      <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z" />
                      <rect x="2" y="9" width="4" height="12" />
                      <circle cx="4" cy="4" r="2" />
                  ...
                  <a href="https://github.com/akshatsoni27" target="_blank" rel="noreferrer" aria-label="GitHub"
                    className="flex h-10 w-10 items-center justify-center rounded-lg border border-stroke bg-surface text-purple-600 transition hover:border-[#2563EB]/40 hover:shadow-sm">
                    <svg viewBox="0 0 24 24" width="17" height="17" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round">
                      <path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22" />
                    </svg>
                  </a>
                  <a href="/Resume_Akshat-soni.pdf" target="_blank" rel="noreferrer" aria-label="Resume"
                    className="flex h-10 w-10 items-center justify-center rounded-lg border border-stroke bg-surface text-yellow-600 transition hover:border-[#2563EB]/40 hover:shadow-sm">
                    <svg viewBox="0 0 24 24" width="17" height="17" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round">
